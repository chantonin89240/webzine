        ...
        public IEnumerable<Titre> CreateTitre()
        {
            return new List<Titre>()
            {
                new Titre(){
                    ...
                    UrlJaquette = "https://images-eu.ssl-images-amazon.com/images/I/61dsMoSVAXL._SR600%2C315_PIWhiteStrip%2CBottomLeft%2C0%2C35_SCLZZZZZZZ_FMpng_BG255%2C255%2C255.jpg", 
                    UrlEcoute = "", 
                    Lien = "",
                ...
                new Titre()
                {
                    ...
                    IdArtiste = 2,
                    Artiste = new Artiste(),
                    Libelle = "Röyksopp - Sordid Affai - Maceo Plex Remix",
                ...
                new Titre()
                {
                    ...
                    IdArtiste = 3,
                    Artiste = new Artiste(),
                    Libelle = "Jean-Michel Jarre - Oxygene, Pt1",
